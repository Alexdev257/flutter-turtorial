(function (global) {
  ...
  var STRINGS = {
    vi: {
      ...
      quizPrev: 'Câu trước',
      quizSkip: 'Bỏ qua',
      quizQuestionNavAria: 'Chọn câu hỏi',
      quizQuestionNavTitle: 'Câu hỏi',
      quizQnavHideTitle: 'Ẩn danh sách',
      quizQnavHideAria: 'Ẩn danh sách câu hỏi',
      quizQnavShowTab: 'Câu hỏi',
      quizQnavShowTitle: 'Hiện danh sách câu',
      quizQnavShowAria: 'Hiện danh sách câu hỏi',
      quizJumpTo: 'Đến câu {i}',
    ...
    en: {
      ...
      quizPrev: 'Previous',
      quizSkip: 'Skip',
      quizQuestionNavAria: 'Question list',
      quizQuestionNavTitle: 'Questions',
      quizQnavHideTitle: 'Hide list',
      quizQnavHideAria: 'Hide question list',
      quizQnavShowTab: 'Questions',
      quizQnavShowTitle: 'Show question list',
      quizQnavShowAria: 'Show question list',
      quizJumpTo: 'Go to question {i}',
